...
const heroUrl = `${import.meta.env.BASE_URL}marketing/summer-hero.jpg`
  ...
  <div class="canvas-shell">
    ...
    <div class="canvas-stage">
        ...
        <div class="phone-wrap">
          ...
          <div class="device-frame" :class="{ 'drag-over': isDragOver, tablet: editorStore.deviceMode === 'tablet' }" @dragover="handleDragOver" @dragleave="handleDragLeave" @drop="handleDrop">
            <div class="device-screen">
              ...
              <div v-if="isDragOver" class="drop-mask"><i class="i-tabler-plus" /><strong>释放以添加组件</strong><span>组件将添加到页面底部，可继续拖拽排序</span></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <aside class="page-strip">
        ...
        <button class="add-page" @click="ElMessage.info('当前设计稿为单页 H5，新增页面将在项目模式提供')"><i class="i-tabler-plus" /><span>新增页面</span></button>
      </aside>
    </div>
  </div>
</template>
