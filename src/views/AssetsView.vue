...
<style scoped>
.shell{min-height:100%;background:var(--surface-0)}.page{max-width:1380px;margin:auto;padding:24px 28px 44px}.page-head{display:flex;justify-content:space-between;align-items:center;margin-bottom:16px}.page-head h1{font-size:22px;margin:0 0 5px;color:var(--text-strong)}.page-head p{margin:0;color:var(--text-muted);font-size:var(--font-size-md)}.primary{height:36px;border:0;border-radius:var(--radius-md);background:var(--brand-600);color:#fff;padding:0 14px;box-shadow:var(--shadow-brand);cursor:pointer}.panel{background:var(--surface-1);border:1px solid var(--border-subtle);border-radius:var(--radius-xl);padding:0 18px 16px;box-shadow:var(--shadow-xs)}.toolbar{min-height:58px;border-bottom:1px solid var(--border-subtle);display:flex;justify-content:space-between;align-items:center}.tabs{display:flex;align-self:stretch;gap:20px}.tabs button{height:58px;border:0;border-bottom:2px solid transparent;background:transparent;color:var(--text-secondary);font-size:var(--font-size-md);cursor:pointer}.tabs button:hover{color:var(--brand-600)}.tabs button.active{border-bottom-color:var(--brand-600);color:var(--brand-600);font-weight:600}.search{width:244px;height:34px;display:flex;align-items:center;padding:0 10px;color:var(--text-muted)}.search input{width:100%;margin-left:6px;font-size:var(--font-size-md)}.grid{display:grid;grid-template-columns:repeat(4,1fr);gap:12px;padding:16px 0}.asset-card,.upload-card{border:1px solid var(--border-subtle);border-radius:var(--radius-lg);overflow:hidden;background:var(--surface-1);position:relative;transition:all var(--motion-base) var(--ease-standard)}.asset-card:hover{transform:translateY(-2px);border-color:var(--border-brand);box-shadow:var(--shadow-sm)}.preview{height:148px;position:relative;display:grid;place-items:center;font-size:32px;color:#fff;overflow:hidden;background:linear-gradient(145deg,#79cbff,#bceee2)}.preview.sea{background:linear-gradient(145deg,#59c8ff,#bdeeff 52%,#ffe2a2)}.preview.green{background:linear-gradient(145deg,#4f8d5a,#c3dfb4)}.preview.coffee{background:linear-gradient(145deg,#7f593e,#e6c5a0)}.preview.building{background:linear-gradient(145deg,#7f9db6,#d7e2eb)}.preview.city{background:linear-gradient(145deg,#293b63,#8e73bc)}.preview.drink{background:linear-gradient(145deg,#f3a65a,#ffe1a9)}.preview.travel{background:linear-gradient(145deg,#68b8e8,#a8dbbb)}.preview.product{background:linear-gradient(145deg,#f0ece7,#d5c7b9)}.preview.icon{background:linear-gradient(145deg,#7d6cf0,#c7bcff)}.preview.illustration{background:linear-gradient(145deg,#ff92b6,#ffd2a8)}.preview.video{background:linear-gradient(145deg,#ff8774,#ffcab0)}.preview.audio{background:linear-gradient(145deg,#5c7dff,#a7b7ff)}.asset-check{position:absolute;right:8px;top:8px;width:22px;height:22px;border-radius:50%;display:grid;place-items:center;background:var(--brand-600);border:2px solid #fff;opacity:0;transform:scale(.8);transition:all var(--motion-base) var(--ease-standard);font-size:11px}.asset-card:hover .asset-check{opacity:1;transform:scale(1)}.hover-actions{position:absolute;inset:0;background:rgba(27,44,70,.34);display:flex;align-items:center;justify-content:center;gap:8px;opacity:0;transition:opacity var(--motion-base) var(--ease-standard)}.asset-card:hover .hover-actions{opacity:1}.hover-actions button{width:34px;height:34px;border:1px solid rgba(255,255,255,.7);border-radius:var(--radius-md);background:rgba(255,255,255,.92);color:var(--brand-600);cursor:pointer}.meta{padding:11px 12px;display:flex;flex-direction:column}.meta strong{font-size:var(--font-size-base);color:var(--text-primary)}.meta span{font-size:var(--font-size-xs);color:var(--text-muted);margin-top:4px}.more{position:absolute;right:8px;bottom:12px;border:0;background:transparent;color:var(--text-muted);cursor:pointer}.upload-card{min-height:198px;border-style:dashed;display:flex;flex-direction:column;align-items:center;justify-content:center;color:var(--text-muted);cursor:pointer}.upload-card:hover{background:var(--brand-50);border-color:var(--border-brand)}.upload-card i{font-size:29px;color:var(--brand-600)}.upload-card strong{margin-top:8px;font-size:var(--font-size-base);color:var(--text-secondary)}.upload-card span{font-size:var(--font-size-xs);margin-top:4px}.empty{height:300px;display:flex;flex-direction:column;align-items:center;justify-content:center;color:var(--text-muted)}.empty i{font-size:36px;color:var(--brand-300)}.empty strong{margin-top:9px;color:var(--text-secondary);font-size:13px}.empty span{font-size:10px;margin-top:4px}.pagination{padding-top:13px;border-top:1px solid var(--border-subtle);display:flex;align-items:center;justify-content:space-between;color:var(--text-muted);font-size:var(--font-size-xs)}.pagination>div{display:flex;gap:5px;align-items:center}.pagination button{min-width:30px;height:30px;border:1px solid var(--border-default);border-radius:var(--radius-sm);background:var(--surface-1);color:var(--text-secondary);cursor:pointer}.pagination button:hover:not(:disabled),.pagination button.active{border-color:var(--border-brand);background:var(--brand-50);color:var(--brand-600)}.pagination button:disabled{opacity:.35;cursor:not-allowed}.pagination em{font-style:normal;padding:0 3px}@media(max-width:1180px){.grid{grid-template-columns:repeat(3,1fr)}.tabs{gap:14px}}@media(max-width:900px){.grid{grid-template-columns:repeat(2,1fr)}.toolbar{align-items:flex-start;gap:12px;flex-direction:column;padding:12px 0}.tabs{width:100%;overflow:auto}.tabs button{height:38px;white-space:nowrap}.search{width:100%}.page{padding:22px 20px}}
</style>
