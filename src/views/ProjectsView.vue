    ...
    <main class="page">
      ...
      <section class="panel">
        <div class="filters">
          ...
          <label class="search"><i class="i-tabler-search" /><input v-model="keyword" placeholder="搜索作品名称" /></label>
        </div>
...
<style scoped>
.page-shell{min-height:100%;background:var(--surface-0)}.page{max-width:1380px;margin:auto;padding:28px 32px 48px}.page-head{display:flex;align-items:center;justify-content:space-between;margin-bottom:18px}.page-head h1{margin:0 0 6px;color:var(--text-strong);font-size:24px}.page-head p{margin:0;color:var(--text-muted);font-size:var(--font-size-md)}.primary{height:var(--control-height-lg);padding:0 16px;border:0;border-radius:var(--radius-md);background:var(--brand-600);color:var(--text-inverse);box-shadow:var(--shadow-brand);cursor:pointer;font-weight:600}.panel{background:var(--surface-1);border:1px solid var(--border-subtle);border-radius:var(--radius-xl);overflow:hidden;box-shadow:var(--shadow-xs)}.filters{padding:16px 18px;border-bottom:1px solid var(--border-subtle);display:flex;align-items:center;justify-content:space-between}.tabs{display:flex;gap:6px}.tabs button{height:34px;padding:0 14px;border:0;border-radius:var(--radius-md);background:transparent;color:var(--text-secondary);cursor:pointer;transition:all var(--motion-base) var(--ease-standard)}.tabs button:hover{color:var(--brand-600);background:var(--brand-50)}.tabs button.active{background:var(--brand-100);color:var(--brand-600);font-weight:600}.search{width:250px;height:var(--control-height-md);border:1px solid var(--border-default);border-radius:var(--radius-md);background:var(--surface-1);display:flex;align-items:center;padding:0 10px;color:var(--text-muted);transition:all var(--motion-base) var(--ease-standard)}.search:focus-within{border-color:var(--border-brand);box-shadow:var(--focus-ring)}.search input{width:100%;margin-left:6px;border:0;outline:0;background:transparent;color:var(--text-primary);font-size:var(--font-size-md)}.tr{display:grid;grid-template-columns:2.3fr .8fr .7fr 1.3fr 1.2fr;align-items:center;min-height:68px;padding:0 20px;border-bottom:1px solid var(--border-subtle);font-size:var(--font-size-md);color:var(--text-secondary)}.tr:last-child{border-bottom:0}.tr.head{min-height:44px;background:var(--surface-2);color:var(--text-muted);font-size:var(--font-size-sm)}.project{display:flex;align-items:center;gap:12px;min-width:0}.project strong{overflow:hidden;color:var(--text-primary);text-overflow:ellipsis;white-space:nowrap}.thumb{width:42px;height:48px;flex:0 0 42px;border-radius:var(--radius-md);display:grid;place-items:center;color:#fff;font-size:19px}.thumb.summer{background:linear-gradient(145deg,#58c8ff,#a8ebd6 58%,#ffe29c)}.thumb.pink{background:linear-gradient(145deg,#ff9fc0,#ffdbe8)}.thumb.blue{background:linear-gradient(145deg,#5d9cff,#c6dcff)}.thumb.dark{background:linear-gradient(145deg,#24354e,#60728d)}.thumb.orange{background:linear-gradient(145deg,#ff9d68,#ffd1a7)}.thumb.violet{background:linear-gradient(145deg,#8e7df2,#d8d0ff)}.tr em{font-style:normal;font-size:var(--font-size-xs);padding:4px 8px;border-radius:10px;background:var(--success-50);color:var(--success-500)}.tr em.draft{background:var(--surface-3);color:var(--text-muted)}.ops{display:flex;gap:4px}.ops button{height:28px;padding:0 8px;border:0;border-radius:var(--radius-sm);background:transparent;color:var(--brand-600);cursor:pointer}.ops button:hover{background:var(--brand-50)}.ops .danger{color:var(--danger-500)}.ops .danger:hover{background:var(--danger-50)}.empty{height:260px;display:flex;flex-direction:column;align-items:center;justify-content:center;color:var(--text-muted)}.empty i{font-size:34px;color:var(--brand-300)}.empty strong{margin-top:10px;color:var(--text-secondary);font-size:var(--font-size-base)}.empty span{margin-top:5px;font-size:var(--font-size-sm)}@media(max-width:1000px){.page{padding:24px 20px}.tr{grid-template-columns:2fr .8fr .7fr 1fr}.tr>span:nth-child(4){display:none}.search{width:210px}}
</style>
