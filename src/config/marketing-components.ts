...
export const marketingComponentRegistry: ComponentRegistry = {
  ...
  goodsList: {
    ...
    defaultProps: {
      title: '热门推荐', productOneName: '安热沙防晒霜 SPF50+', productOnePrice: '159', productOneOriginalPrice: '199', productOneImage: productSunscreen,
      productTwoName: '新品蓝牙耳机 轻盈舒适', productTwoPrice: '299', productTwoOriginalPrice: '399', productTwoImage: productHeadphones, accentColor: '#ff4d4f',
    },
    ...
    propSchema: [
      ...
      { key: 'productOneImage', label: '商品 1 图片', type: PropType.Image, defaultValue: productSunscreen },
      ...
      { key: 'productTwoImage', label: '商品 2 图片', type: PropType.Image, defaultValue: productHeadphones },
